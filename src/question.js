export class Question {
    ...
    static fetch(token) {
        ...
        return fetch(`https://podcastpurejs-default-rtdb.europe-west1.firebasedatabase.app/questions.json?auth=${token}`)
            .then(response => response.json())
            .then(response => {
    ...
    static renderList() {
        ...
        const html = questions.length
            ...
            : `<div class="mui--text-headline">You have not gave any questions</div>`
